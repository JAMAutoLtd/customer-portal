import type { Tables } from './staged.database.types'; // Import base types if needed

// --- Type Aliases (Copied from baseline.ts for self-containment) ---
...
export const ymmRefData: YmmRef[] = [
...
export const customerVehiclesData: CustomerVehicle[] = [
  ...
  { id: 46, vin: 'VIN_VAN_1', make: 'Ford', model: 'Transit', year: 2022 },
...
export const immoRequirementsData: RequirementInsertBase[] = [
...
export const progRequirementsData: RequirementInsertBase[] = [
...
export const airbagRequirementsData: RequirementInsertBase[] = [
...
export const adasRequirementsData: AdasRequirementInsert[] = [
  { ymm_id: 4321, service_id: 1, equipment_model: 'AUTEL-CSC0605/01' },
  { ymm_id: 4321, service_id: 2, equipment_model: 'AUTEL-CSC0601/01' },
  { ymm_id: 4321, service_id: 3, equipment_model: 'AUTEL-CSC0602/01' },
  { ymm_id: 4321, service_id: 4, equipment_model: 'AUTEL-CSC0806/01' },
  { ymm_id: 4470, service_id: 1, equipment_model: 'N/A' },
  { ymm_id: 4470, service_id: 2, equipment_model: 'AUTEL-CSC0601/06' },
  { ymm_id: 4470, service_id: 3, equipment_model: 'AUTEL-CSC0802' },
  { ymm_id: 4470, service_id: 4, equipment_model: 'N/A' },
  { ymm_id: 4599, service_id: 1, equipment_model: 'N/A' },
  { ymm_id: 4599, service_id: 2, equipment_model: 'AUTEL-CSC0601/11/01' },
  { ymm_id: 4599, service_id: 3, equipment_model: 'AUTEL-CSC0800' },
  { ymm_id: 4599, service_id: 4, equipment_model: 'N/A' },
  { ymm_id: 4851, service_id: 1, equipment_model: 'AUTEL-CSC0800' },
  { ymm_id: 4851, service_id: 2, equipment_model: 'AUTEL-CSC0601/12' },
  { ymm_id: 4851, service_id: 3, equipment_model: 'N/A' },
  { ymm_id: 4851, service_id: 4, equipment_model: 'N/A' },
  { ymm_id: 7890, service_id: 1, equipment_model: 'Dynamic Calibration' },
  { ymm_id: 7890, service_id: 2, equipment_model: 'AUTEL-CSC0601/13' },
  { ymm_id: 7890, service_id: 3, equipment_model: 'Dynamic Calibration' },
  { ymm_id: 7890, service_id: 4, equipment_model: 'AUTEL-CSC1004/03' },
  { ymm_id: 5252, service_id: 1, equipment_model: 'N/A' },
  { ymm_id: 5252, service_id: 2, equipment_model: 'AUTEL-CSC0601/17' },
  { ymm_id: 5252, service_id: 3, equipment_model: 'N/A' },
  { ymm_id: 5252, service_id: 4, equipment_model: 'N/A' },
  { ymm_id: 7500, service_id: 1, equipment_model: 'N/A' },
  { ymm_id: 7500, service_id: 2, equipment_model: 'AUTEL-CSC0601/22' },
  { ymm_id: 7500, service_id: 3, equipment_model: 'N/A' },
  { ymm_id: 7500, service_id: 4, equipment_model: 'N/A' },
  { ymm_id: 9688, service_id: 1, equipment_model: 'AUTEL-CSC0800' },
  { ymm_id: 9688, service_id: 2, equipment_model: 'AUTEL-CSC0601/25' },
  { ymm_id: 9688, service_id: 3, equipment_model: 'AUTEL-CSC0800' },
  { ymm_id: 9688, service_id: 4, equipment_model: 'N/A' },
  { ymm_id: 4616, service_id: 1, equipment_model: 'AUTEL-CSC0605/01' },
