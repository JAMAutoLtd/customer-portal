...
-   [ ] ~~**Refine Window Filling Logic (`src/scheduler/scheduler.py`):** Improve travel time calculation accuracy when fitting dynamic units into windows in `update_job_queues_and_routes`.~~ (**Integrated into Phase 3 - update_job_queues_and_routes**)
