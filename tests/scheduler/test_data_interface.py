...
from src.scheduler import data_interface
...
from src.scheduler.api.models import (
...
def mock_make_request():
    ...
    with patch('src.scheduler.data_interface._make_request') as mock:
        yield mock
...
@patch('src.scheduler.data_interface._make_request')
