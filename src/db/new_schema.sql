...
CREATE TYPE job_status_enum AS ENUM ('Pending', 'Scheduled', 'InProgress', 'Completed', 'Cancelled');
CREATE TYPE service_category_enum AS ENUM ('adas', 'airbag', 'immo', 'prog', 'diag');
...
CREATE TABLE equipment (
    id SERIAL PRIMARY KEY,
    equipment_type service_category_enum UNIQUE,
    model TEXT
);
...
COMMENT ON TABLE equipment_requirements IS 'Defines what equipment is required for specific vehicle models and services'; 